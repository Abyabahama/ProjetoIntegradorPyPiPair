...
public class TelaCartasMedia2 extends JFrame implements ActionListener{
    ...
    TelaCartasMedia2() {
        ...
        pontos = new JLabel("Pontuação: 90");
        ...
        JLabel pergunta = new JLabel("O que podemos utilizar para simplificar a escrita de vários if else encadeados em Python?");
        ...
        List<String> respostas = Arrays.asList("for", "while", "elif", "switch", "foreach", "len", "len", "foreach",
        "for","while","elif","switch");
    ...
    ClickedButtonMedia2 clickedButton = new ClickedButtonMedia2();
        ...
        if (cartaSelecionada.isVirada()) {
            ...
            if (clickedButton.getCarta1() == null) {
                ...
                if (clickedButton.verificarPar()) {
                    ...
                    TelaCartasMedia3 novaTelaMedia3 = new TelaCartasMedia3();
                    novaTelaMedia3.setVisible(true);
