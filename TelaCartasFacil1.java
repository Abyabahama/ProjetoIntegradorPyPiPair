...
public class TelaCartasFacil1 extends JFrame implements ActionListener{
    ...
    TelaCartasFacil1() {
        ...
        pontos = new JLabel("Pontuação: 10");
        ...
        JLabel pergunta = new JLabel("Qual é o símbolo utilizado em um fluxograma para representar uma decisão?");
        ...
        List<String> respostas = Arrays.asList("quadrado", "triângulo", "losango", "quadrado", "triângulo", "losango", "circulo", "circulo");
        ...
        if (cartaSelecionada.isVirada()) {
            ...
            if (clickedButton.getCarta1() == null) {
                ...
                if (clickedButton.verificarPar()) {
                    ...
                    TelaCartasFacil2 novaTelaFacil2 = new TelaCartasFacil2();
                    novaTelaFacil2.setVisible(true);
                    dispose();
