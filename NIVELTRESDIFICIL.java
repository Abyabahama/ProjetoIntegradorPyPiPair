...
NEXT = new JButton("Avançar");
    ...
    public void actionPerformed(ActionEvent e) {
        NIVELQUATRODIFICIL nivelquatrodificil = new NIVELQUATRODIFICIL();
        ...
        frame.getContentPane().add(nivelquatrodificil); // Adicione o painel da nova tela ao conteúdo do JFrame
