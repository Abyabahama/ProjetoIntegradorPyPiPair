...
public class TelaCartasDificil extends JFrame implements ActionListener{
    ...
    TelaCartasDificil() {
        ...
        pontos = new JLabel("Pontuação: 150");
        ...
        JLabel pergunta = new JLabel("O que é necessário para chamar uma função em Python?");
    ...
    ClickedButtonDificil clickedButton = new ClickedButtonDificil();
        ...
        if (cartaSelecionada.isVirada()) {
            ...
            if (clickedButton.getCarta1() == null) {
                ...
                if (clickedButton.verificarPar()) {
                    ...
                    TelaCartasDificil1 novaTelaDificil1 = new TelaCartasDificil1();
                    novaTelaDificil1.setVisible(true);
