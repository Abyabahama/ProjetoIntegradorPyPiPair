...
public class TelaCartasFacil4 extends JFrame implements ActionListener{
    ...
    TelaCartasFacil4() {
        ...
        pontos = new JLabel("Pontuação: 40");
        ...
        JLabel pergunta = new JLabel("Qual a função em python que devolve um iterável ordenado");
        ...
        List<String> respostas = Arrays.asList("sort", "remove", "length()", "length()", "sorted", "sorted", "remove", "sort");
    ...
    ClickedButton4 clickedButton = new ClickedButton4();
        ...
        if (cartaSelecionada.isVirada()) {
            ...
            if (clickedButton.getCarta1() == null) {
                ...
                if (clickedButton.verificarPar()) {
                    ...
                    TelaCartasMedia novaTelaMedia = new TelaCartasMedia();
                    novaTelaMedia.setVisible(true);
                    dispose();
