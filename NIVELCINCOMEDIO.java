...
public class NIVELCINCOMEDIO extends JFrame {
...
NEXT.addActionListener(new ActionListener() {
    ...
    public void actionPerformed(ActionEvent e) {
        NIVELUMDIFICIL nivelumdificil = new NIVELUMDIFICIL();
        

        // Trocar de tela
        painel.removeAll();
        painel.add(nivelumdificil);
        painel.revalidate();
        painel.repaint();
    }
});
...
public static void main(String[] args) {
    NIVELCINCOMEDIO p1 = new NIVELCINCOMEDIO();
    }
