...
public class NIVELDOISFACIL extends JFrame {
...
NEXT.addActionListener(new ActionListener() {
    ...
    public void actionPerformed(ActionEvent e) {
        NIVELTRESFACIL niveltresfacil = new NIVELTRESFACIL();
        

        // Trocar de tela
        painel.removeAll();
        painel.add(niveltresfacil);
        painel.revalidate();
        painel.repaint();
    }
});
...
public static void main(String[] args) {
    NIVELDOISFACIL p1 = new NIVELDOISFACIL();
    }
