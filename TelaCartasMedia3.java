...
public class TelaCartasMedia3 extends JFrame implements ActionListener{
    ...
    TelaCartasMedia3() {
        ...
        JLabel pergunta = new JLabel("O que podemos utilizar para interromper a execução de um laço de repetição em Python?");
    ...
    ClickedButtonMedia3 clickedButton = new ClickedButtonMedia3();
        ...
        if (cartaSelecionada.isVirada()) {
            ...
            if (clickedButton.getCarta1() == null) {
                ...
                if (clickedButton.verificarPar()) {
                    ...
                    TelaCartasMedia4 novaTelaMedia4 = new TelaCartasMedia4();
                    novaTelaMedia4.setVisible(true);
