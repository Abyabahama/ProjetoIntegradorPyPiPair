...
public class TelaCartasDificil3 extends JFrame implements ActionListener{
    ...
    ClickedButtonDificil3 clickedButton = new ClickedButtonDificil3();
        ...
        if (cartaSelecionada.isVirada()) {
            ...
            if (clickedButton.getCarta1() == null) {
                ...
                if (clickedButton.verificarPar()) {
                    ...
                    TelaCartasDificil4 novaTelaDificil4 = new TelaCartasDificil4();
                    novaTelaDificil4.setVisible(true);
